...
public class AddressDaoH2 implements IDao<Address> {
    private static final String SQL_INSERT = "INSERT INTO ADDRESSES (STREET, NUMBER, LOCATION, STATE) VALUES(?,?,?,?)";
    private static final String SQL_SELECT_ID = "SELECT * FROM ADDRESSES WHERE ID =?";
    private static final String SQL_UPDATE = "UPDATE ADDRESSES SET STREET=?, NUMBER=?, LOCATION=?, STATE=? WHERE ID=?";
